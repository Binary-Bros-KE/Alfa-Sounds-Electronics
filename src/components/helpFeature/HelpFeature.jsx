  ...
  return (
    <div className="px-4 mx-auto py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-sm:mx-4">
        ...
        <div className="bg-gray-200 p-8 rounded-lg">
          ...
          <div className="flex gap-2 max-sm:flex-col">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
            />
        ...
        {/* Help Section */}
        <div className="bg-white p-8 rounded-lg border border-green-300">
          ...
          <a href="whatsapp://send?phone=+254720434209" className="flex flex-col items-center gap-2 group">
              <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-green-50 transition-colors">
                <i className="fab fa-whatsapp w-6 h-6 text-gray-600 group-hover:text-green-600 text-2xl"></i>
              </div>
              <span className="text-sm text-gray-600 group-hover:text-green-600">Chat Online</span>
            </a>
            <a href="tel:+254720434209" className="flex flex-col items-center gap-2 group">
              ...
              <span className="text-sm text-gray-600 group-hover:text-green-600">Call Us</span>
            </a>
            <a href="mailto:info@alfaelectronics.co.ke" className="flex flex-col items-center gap-2 group">
              <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-green-50 transition-colors">
                <Mail className="w-6 h-6 text-gray-600 group-hover:text-green-600" />
              </div>
              <span className="text-sm text-gray-600 group-hover:text-green-600">E-mail</span>
            </a>
          </div>
        </div>
      </div>
